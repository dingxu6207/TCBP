...
emcee_trace[0,:] = emcee_trace[0,:]*5850
####################

if index == 1:
    emcee_trace[1,:] = emcee_trace[1,:]*90
    figure = corner.corner(emcee_trace.T[:,0:6],bins=100,
                           labels=[r"$T_1$", r"$incl$", r"$q$", r"$f$", r"$T_2/T_1$", r"$l3$", r"$offset1$", r"$offset2$"],
...
if index == 0:
    emcee_trace[1,:] = emcee_trace[1,:]*90
    figure = corner.corner(emcee_trace.T[:,0:5],bins=100,
                           labels=[r"$T_1$", r"$incl$", r"$q$", r"$f$", r"$T_2/T_1$", r"$offset1$", r"$offset2$"],
                           label_kwargs={"fontsize": 15},title_fmt='.4f',show_titles=True, title_kwargs={"fontsize": 15}, color ='blue',
                           fill_contours=True,smooth=0.3,smooth1d=0.3)
